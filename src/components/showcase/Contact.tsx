...
import twitterIcon from '../../assets/pictures/contact-instagram.png';
    ...
    async function submitForm() {
        ...
        try {
            ...
            const res = await fetch(
                'https://692960a69d311cddf3494830.mockapi.io/api_JavaScript/Users/',
                {
                    method: 'POST',
                    headers: {
        ...
        <div className="site-page-content">
            <div style={styles.header}>
                ...
                <div style={styles.socials}>
                    <SocialBox
                        icon={ghIcon}
                        link={'https://github.com/RexshanSam/'}
                    />
                    <SocialBox
                        icon={inIcon}
                        link={'https://www.linkedin.com/in/rexshan-s-b04984298/'}
                    />
                    <SocialBox
                        icon={twitterIcon}
                        link={'https://www.instagram.com/_rexshan_/'}
                    />
                </div>
            </div>
            <div className="text-block">
                <p>
                    I am currently Seeking a Job,if you have any
                    opportunities, Please  reach Me out - I would love to
