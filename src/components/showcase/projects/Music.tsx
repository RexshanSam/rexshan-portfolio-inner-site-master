        ...
        <div className="site-page-content">
            ...
            <div className="text-block">
                <p>
                    ...
                    was 15 years old, I Started Singing in a Competetion and started to
                    Learn music,Like KeyBoard(4 Parts And Chords)
                </p>
                <br />
                <p>
                    I like the Which Is Simple Beat music that I make Music Songs Using Sono Ai and Publich The Song
                    with Fully finished songs,lyrics, but also it's not a
                ...
                <br />
                <p>
                    Below are some more recent Musical Songs  I've been
